        ...
        <div className="w-full max-w-2xl mx-auto">
          <div className="flex mx-5 my-10">
            <div className={styles['privacy-page']}>
              ...
              <p>Your privacy is important to us. It is Liqras' policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://liqras.com">https://liqras.com</a>, and other sites we own and operate.</p>
